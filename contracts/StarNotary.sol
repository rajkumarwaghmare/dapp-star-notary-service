...
contract StarNotary is ERC721 {
    ...
    // Implement lookUptokenIdToStarInfo
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, "You can't exchage the Star you don't own");
        _transfer(owner1, owner2, _tokenId1);
        _transfer(owner2, owner1, _tokenId2);
        //No need to worry about the price here.
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        //Confirm: Do we need to care about Star price value transfer from owner to _to1 ?
    }
